use crate::{
    ...
    ParkedCar, ParkingSimState, ParkingSpot, PedestrianID, PersonSpec, Router, Scheduler,
...
impl Sim {
    ...
    pub fn seed_all_people(&mut self, people: &Vec<PersonSpec>) {
        for p in people {
            self.trips.new_person(p);
        }
        self.trips.check_trips_have_people();
    }
